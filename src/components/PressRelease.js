...
const PressRelease = () => {
  const pressReleases = [
    { date: '2024.4.18', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
    { date: '2024.4.18', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
    { date: '2024.4.17', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
    { date: '2024.4.16', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
    { date: '2024.4.15', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
    { date: '2024.4.14', content: '介護現場における被介護者の状態の見える化実証事業を開始致しました。' },
